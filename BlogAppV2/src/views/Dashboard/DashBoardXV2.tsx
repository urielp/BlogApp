...
const DashBoardXV2 = (props: Props) => {
  ...
  console.log("in new dashboard component based ");
  console.log("card title", classes.cardTitle);
  return (
    <div>
      <GridContainer>
...
export default withStyles(dashboardStyle)(DashBoardXV2);
